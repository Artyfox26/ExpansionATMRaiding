...
{	
    ...
    {
		m_Root 			= Widget.Cast(GetGame().GetWorkspace().CreateWidgets("ExpansionATMRaiding/GUI/Layouts/HackingNotification.layout"));
	...
	void Init(string Heading, string Message, string NotificationIcon = "ExpansionATMRaiding/GUI/Images/hacking.paa", float timeSeconds = 8)	
	{
